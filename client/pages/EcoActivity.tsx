        ...
        <div className="grid md:grid-cols-2 gap-4">
          <section className="pixel-card space-y-3">
            ...
            <p className="text-xs opacity-70">
              AI verification will confirm photo
            </p>
          </section>
          ...
          <section className="pixel-card space-y-3">
            ...
            <div className="overflow-x-auto">
              <div className="flex gap-3 min-w-max">
                {["Zero-plastic day", "Cycle to class", "Plant a sapling"].map(
                  (t) => (
                    <div
                      key={t}
                      className="pixel-card w-56 flex flex-col gap-2"
                    >
                      <div>{t}</div>
          ...
          >
            <div className="pixel-card max-w-md w-full text-center space-y-4">
              ...
              <div className="aspect-square w-64 mx-auto rounded-full border-[6px] border-foreground grid place-items-center relative overflow-hidden">
                <div
                  className="absolute w-full h-full animate-spin [animation-duration:3s]"
                  style={{
                    background: `conic-gradient(hsl(var(--accent)), hsl(var(--secondary)), hsl(var(--primary)), hsl(var(--accent)))`,
                  }}
                />
