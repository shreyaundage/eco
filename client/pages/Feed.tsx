...
const mockPosts = [
  {
    id: 1,
    user: "Aarav",
    img: "https://cdn.builder.io/api/v1/image/assets%2F5bf6c489e64643709f1a564990245c30%2F2ede066d2401437faa8fecb3aaefc377",
    text: "Planted a tree near the library!",
    likes: 116,
  },
  {
    id: 2,
    user: "Mia",
    img: "https://cdn.builder.io/api/v1/image/assets%2F5bf6c489e64643709f1a564990245c30%2Fd358edc073b14838ba2cb5f37ffdee2a",
    text: "Cycle-to-class challenge complete.",
    likes: 65,
  },
];
        ...
        <section className="pixel-card">
          ...
          <div className="overflow-x-auto">
            <div className="flex gap-3 min-w-max">
              {["Solar benches", "Campus garden", "Rainwater harvest"].map(
                (p) => (
                  <div key={p} className="pixel-card w-64">
                    <div className="mb-2">{p}</div>
                    <div className="h-2 bg-secondary rounded-sm overflow-hidden mb-2">
              ...
              <div className="flex gap-2 mt-2">
                <button
                  ...
                  onClick={() =>
                    setLikes((s) => ({
                      ...s,
                      [post.id]: (s[post.id] ?? post.likes) + 1,
                    }))
                  }
                >
