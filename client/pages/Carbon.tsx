            ...
            <div>
              <label htmlFor="upload" className="block">
                ...
                <div
                  ...
                  className="pixel-border h-64 grid place-items-center cursor-pointer bg-card"
                >
                  {fileSrc ? (
                    <img
                      src={fileSrc}
              ...
              <div className="mt-3 text-sm opacity-70">
                Once uploaded, we will analyze the plant and estimate carbon
                impact.
              </div>
            </div>
            ...
            <aside className="space-y-3">
              ...
              <div className="mt-4 pixel-card">
                ...
                <div className="text-sm">
                  Try close-up shots of leaves or full tree trunk for best
                  results.
                </div>
              </div>
            </aside>
        ...
        {loading && (
          <div className="grid place-items-center">
            <div className="pixel-card p-6 flex flex-col items-center gap-3">
              <div className="animate-bounce text-4xl text-primary">
                <Leaf />
              </div>
              <div className="font-pixel">Analyzing...</div>
              <div className="w-48 h-3 bg-secondary rounded-sm overflow-hidden">
                <div
          ...
          >
            <div className="pixel-card max-w-lg w-full text-left p-6 relative">
              <div className="flex items-center justify-between">
                <div
                  className="font-pixel text-lg bg-yellow-200 px-3 py-1 rounded-sm"
                ...
                <div className="space-y-3 flex flex-col items-center">
                  <div className="w-40 h-40 bg-secondary grid place-items-center rounded-sm overflow-hidden">
                    {fileSrc ? (
                      ...
                      <div className="font-pixel opacity-70">No image</div>
                    )}
                  </div>
                  <div className="text-sm opacity-80">
                    All figures are estimates for educational use.
                  </div>
